            ...
            <div class="d-flex gap-2">
                ...
                <div class="dropdown">
                    ...
                    <button class="btn border-0 dropdown-toggle dropdown-toggle-no-caret" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="<?= get_image_url('https://avatar.iran.liara.run/username?username=' . urlencode($fullname_session)); ?>" class="rounded-circle" alt="<?= $fullname_session; ?>" height="34" width="34">
                    </button>
