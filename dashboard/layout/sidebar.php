    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            ...
            <ul class="menu">
                ...
                <li
                    class="sidebar-item <?= ($page_name === 'Kontak Situs') ? 'active' : ''; ?> ">
                    <a href="<?= base_url('dashboard/contact/show.php'); ?>" class='sidebar-link'>
                        <i class="bi bi-telephone-fill"></i>
                        <span>Kontak Situs</span>
                    </a>
                </li>
            </ul>
        </div>
