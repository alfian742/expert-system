                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <ol class="mb-3">
                                            ...
                                            <li>Kondisi yang dapat dipilih adalah:
                                                <ul>
                                                    <li><strong>Tidak</strong>: Gejala tidak dialami sama sekali.</li>
                                                    <li><strong>Tidak Tahu</strong>: Tidak yakin apakah gejala tersebut ada atau tidak.</li>
                                                    <li><strong>Mungkin</strong>: Gejala bisa saja ada, tetapi tidak pasti.</li>
                                                    <li><strong>Kemungkinan Besar</strong>: Gejala sangat mungkin ada, namun belum dapat dipastikan.</li>
                                                    <li><strong>Pasti</strong>: Gejala pasti ada dan sangat jelas.</li>
                                                    <li><strong>Sangat Pasti</strong>: Gejala sangat jelas dan dipastikan ada dengan tingkat kepastian yang tinggi.</li>
                                                </ul>
                                            </li>
                                        ...
                                        <p class="mb-0">
                                            Jika Anda memiliki pertanyaan lebih lanjut, silakan hubungi dokter atau pakar kesehatan atau klik link <strong><a class="link-primary" href="<?= base_url('user/contact.php'); ?>">disini</a></strong>.
                                        </p>
                                    </div>
                                </div>
                            </div>
