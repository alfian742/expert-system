...
if ($contacts->num_rows > 0) {
    ...
    $contact_facebook   = $result_contacts['facebook'];
    $contact_twitter    = $result_contacts['twitter'];
    $contact_tiktok     = $result_contacts['tiktok'];
    $contact_youtube    = $result_contacts['youtube'];
    $contact_address    = $result_contacts['address'];
}
?>
...
<div class="card rounded-0 m-0">
    <div class="card-body px-0 pb-0 pt-1 border-top">
        <div class="container p-4">
            <div class="row">
                <div class="col-lg-6">
                    <img src="<?= get_image_url(base_url('assets/img/static/logo-dark-theme.png')); ?>" alt="Logo" class="d-inline-block mb-4" height="64">

                    <div class="d-flex flex-column gap-1 mb-4">
                        <h4 class="text-white mb-0">Sistem Pakar</h4>
                    ...
                    <div class="d-flex flex-column gap-2 mb-4">
                        ...
                        <a class="link-footer d-flex gap-3 align-items-center" target="_blank" href="<?= "https://www.google.com/maps?q=" . urlencode($contact_address); ?>">
                    ...
                    <div class="row mb-4">
                        <div class="col">
                            ...
                            <div class="d-flex flex-column gap-2">
                                ...
                                <a href="<?= base_url('user/contact.php'); ?>" class="link-footer">Kontak</a>
                        ...
                        <div class="col">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <?php if (!empty($contact_facebook)): ?>
                                    <a href="<?= htmlspecialchars($contact_facebook); ?>" target="_blank" class="btn btn-sm btn-footer icon">
                                        <i class="bi bi-facebook"></i>
                                    </a>
                                <?php endif; ?>

                                <?php if (!empty($contact_twitter)): ?>
                                    <a href="<?= htmlspecialchars($contact_twitter); ?>" target="_blank" class="btn btn-sm btn-footer icon">
                                        <i class="bi bi-twitter-x"></i>
                                    </a>
                                <?php endif; ?>

                                <?php if (!empty($contact_tiktok)): ?>
                                    <a href="<?= htmlspecialchars($contact_tiktok); ?>" target="_blank" class="btn btn-sm btn-footer icon">
                                        <i class="bi bi-tiktok"></i>
                                    </a>
                                <?php endif; ?>

                                <?php if (!empty($contact_youtube)): ?>
                                    <a href="<?= htmlspecialchars($contact_youtube); ?>" target="_blank" class="btn btn-sm btn-footer icon">
