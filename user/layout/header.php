                ...
                <div class="container px-2">
                    <a class="navbar-brand text-uppercase" href="<?= base_url('user/index.php'); ?>">
                        <div class="d-flex justify-content-start align-items-center gap-2">
                            <div class="navbar-logo-container">
                                <img class="theme-logo navbar-logo" src="<?= get_image_url(base_url('assets/img/static/logo-light-theme.png')); ?>" alt="Logo">
                            </div>
                            <div class="d-flex flex-column text-start">
                                <span class="navbar-brand-title fw-bold">Sistem Pakar</span>
                    ...
                    <div class="collapse navbar-collapse py-2" id="navbarNav">
                        <ul class="navbar-nav ms-auto text-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($page_name == 'Kontak') ? 'active' : ''; ?>" href=" <?= base_url('user/contact.php'); ?>">Kontak</a>
                            </li>
                            <li class="nav-item">
